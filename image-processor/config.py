...
VTON_LIGHTNING_MODEL = os.getenv(
    "VTON_LIGHTNING_MODEL", "lightx2v/Qwen-Image-Edit-2511-Lightning"
).strip()
VTON_LIGHTNING_WEIGHT = os.getenv(
    "VTON_LIGHTNING_WEIGHT",
...
VTON_DTYPE = os.getenv("VTON_DTYPE", "bf16").strip().lower()
VTON_OFFLOAD_MODE = os.getenv("VTON_OFFLOAD_MODE", "group").strip().lower()
...
VTON_OUTPUT_MAX_PIXELS = int(os.getenv("VTON_OUTPUT_MAX_PIXELS", str(1024 * 1024)))
