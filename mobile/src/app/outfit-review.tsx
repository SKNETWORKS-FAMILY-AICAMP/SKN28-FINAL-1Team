...
const styles = StyleSheet.create({
  ...
  close: { fontSize: 18, color: ink(0.55) },
  content: { padding: 24, paddingBottom: 40 },
  title: { marginTop: 10, fontFamily: Fonts.serif, fontSize: 28, lineHeight: 36, color: INK },
  body: { marginTop: 13, fontSize: 14, lineHeight: 21, color: ink(0.58) },
  photoBox: { height: 300, marginTop: 28, borderRadius: 20, overflow: 'hidden', backgroundColor: Editorial.surface },
  photoEmpty: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 7 },
  photoIcon: { fontSize: 32, color: ink(0.42) },
  photoLabel: { fontSize: 14, fontWeight: '600', color: INK },
  photoHint: { fontSize: 12, color: ink(0.45) },
  ...
  primary: { height: 52, marginTop: 26, borderRadius: 999, alignItems: 'center', justifyContent: 'center', backgroundColor: INK },
  primaryDisabled: { backgroundColor: ink(0.22) },
  primaryText: { color: '#ffffff', fontSize: 14, fontWeight: '600' },
  privacy: { marginTop: 13, textAlign: 'center', fontSize: 11, lineHeight: 16, color: ink(0.42) },
  resultImage: { height: 250, borderRadius: 20 },
  resultEyebrow: { marginTop: 22, fontSize: 10, letterSpacing: 1.6, fontWeight: '600', color: ink(0.45) },
  feedbackCard: { marginTop: 22, borderRadius: 16, padding: 18, backgroundColor: Editorial.surface },
  feedbackTitle: { fontSize: 13, fontWeight: '700', color: INK },
  feedbackText: { marginTop: 9, fontSize: 13, lineHeight: 21, color: ink(0.65) },
  ...
  tipText: { marginTop: 9, fontSize: 13, lineHeight: 20, color: ink(0.65) },
  ...
  checkboxOn: { borderColor: INK, backgroundColor: INK },
  check: { fontSize: 12, fontWeight: '700', color: '#ffffff' },
  itemText: { fontSize: 13, color: ink(0.72) },
});
