...
export const FAQ: FaqItem[] = [
  ...
  {
    q: '예산에 맞는 상품만 보고 싶어요',
    a: '마이 > 예산에서 금액을 정하면 추천 상품이 예산 안쪽부터 먼저 나와요. 예산을 넘는 상품도 함께 보여주되 뒤로 밀려요.',
  },
  {
    q: '체형 사진은 어디에 쓰이나요',
...
export const PRIVACY_SECTIONS: { title: string; body: string }[] = [
  {
    title: '무엇을 받나요',
    body: '소셜 로그인(네이버·카카오·구글)으로 받은 이메일과 닉네임, 그리고 사용자가 직접 넣은 것들이에요 — 옷 사진, 체형 치수와 촬영 사진, 추구미·퍼스널컬러·예산 설정.',
  },
  {
    title: '어디에 쓰나요',
