...
| 2 | [02-personal-color.md](../color/docs/02-personal-color.md) | 4시즌 × 4 카테고리 + 16 sub-type |
| 3 | [03-color-categories.md](../color/docs/03-color-categories.md) | 4 카테고리 정의 + 30+ 메인컬러 |
| 4 | [04-combination-rules.md](../color/docs/04-combination-rules.md) | Michael 84 차트 + R1~R4 |
...
**퍼스널컬러 적용할 때**:
1. [02-personal-color.md](../color/docs/02-personal-color.md) 4시즌 × 4 카테고리
