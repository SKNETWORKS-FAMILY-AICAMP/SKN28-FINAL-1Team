...
* **일반 코디 그리드:** `color/images/outfits/outfit_grid_[color].png` (Beige, Black, Cream 등 17개 색상별 코디 조합 이미지)
* **큐레이션 조합 (Curated Outfits):** `color/images/outfits/curated/` (매칭 룰에 따라 조합된 세트 이미지)
* **퍼스널 컬러별 연출 (Personal Color):** `color/images/outfits/personal_color/` (Spring, Summer, Autumn, Winter 계절별 연출 시각화)
* **실용 매칭 (Practical Outfits):** `color/images/outfits/practical/` (실제 착용을 고려한 코디 이미지)
...
- **시각 효과**: 명도 기준 — [체형 규칙](02-body-proportion-rules.md)이 이 값을 참조한다
